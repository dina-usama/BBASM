...
embedding_dim = 300
max_seq_length = 10
savepath = 'C:/Users/dina_/Desktop/final/Embeddings results/modelBiGRU.h5'
...
def shared_model_BiGRU(_input):
    ...
    l_bigru = Bidirectional(GRU(100, return_sequences=True))(embedded_sequences)
...
if __name__ == '__main__':
    ...
    left_sen_representation = shared_model_BiGRU(left_input)
    print('left snetcen presentation', left_sen_representation)
    right_sen_representation = shared_model_BiGRU(right_input)
    ...
    plt.savefig('C:/Users/dina_/Desktop/final/Embeddings results/historyGraph.png')
